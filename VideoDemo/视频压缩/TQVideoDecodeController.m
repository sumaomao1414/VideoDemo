...
#import "TQVideoDecodeController.h"
#import "LYOpenGLView.h"
#import <VideoToolbox/VideoToolbox.h>

@interface TQVideoDecodeController ()
...
@implementation TQVideoDecodeController
...
- (void)viewDidLoad {
    ...
    self.mLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 30, 200, 100)];
    self.mLabel.textColor = [UIColor redColor];
    [self.view addSubview:self.mLabel];
    self.mLabel.text = @"测试H264硬解码";
    
    UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(200, 30, 100, 100)];
